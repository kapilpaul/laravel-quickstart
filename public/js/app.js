...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_index__ = __webpack_require__(33);
/**
...
__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.baseURL = "http://hrmanagement.localhost/api/";

__WEBPACK_IMPORTED_MODULE_0_axios___default.a.interceptors.response.use(function (response) {
  return response;
}, function (error) {
  __WEBPACK_IMPORTED_MODULE_1__store_index__["a" /* store */].dispatch("setSubmitted", false);
  __WEBPACK_IMPORTED_MODULE_1__store_index__["a" /* store */].dispatch("setValidationErrors", error.response.data);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_common__ = __webpack_require__(35);
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
  ...
  actions: {
    setParticipants: function setParticipants(_ref, payload) {
  ...
  modules: {
    commonStore: __WEBPACK_IMPORTED_MODULE_2__modules_common__["a" /* commonStore */]
  }
});
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return commonStore; });
var commonStore = {
  state: {
    validationErrors: [],
    submitted: false,
  ...
  mutations: {
    ...
    setPage: function setPage(state, payload) {
      state.page = payload;
    },
    setPageCount: function setPageCount(state, payload) {
  ...
  actions: {
    ...
    setSubmitted: function setSubmitted(_ref2, payload) {
    ...
    setPageCount: function setPageCount(_ref5, payload) {
